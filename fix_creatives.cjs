...
// 3. Update grid UI
const oldButton = `<div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    <button
...
const newButton = `<div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3 backdrop-blur-[2px]">
                    <button
...
// Note: the indentation might differ slightly, let's use regex to find the button block
content = content.replace(
