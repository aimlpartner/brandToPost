...
export function Waitlist() {
  ...
  const trackEvent = useCallback((eventName: string, userEmail = "No Email", extraData = {}, locOverride = null) => {
    try {
  ...
  return (
    <div className="waitlist-page min-h-screen flex flex-col bg-[#050508] text-zinc-300 font-sans selection:bg-[#7C3AED] selection:text-white relative overflow-x-hidden overflow-y-auto select-none">

      {/* Cinematic Styling Overrides & Google Fonts Integration */}
      <style>{`
        /* Force headers to be white on waitlist page (overrides index.css global h1-h6 color rules) */
        .waitlist-page h1,
        .waitlist-page h2,
        .waitlist-page h3,
        .waitlist-page h4,
      ...
      <div 
        className="absolute top-[-10%] left-1/4 w-[700px] h-[500px] rounded-full blur-[140px] pointer-events-none z-0"
        style={{ backgroundColor: 'rgba(124, 58, 237, 0.08)' }}
      ></div>
      <div 
        className="absolute bottom-[-10%] right-[10%] w-[400px] h-[400px] rounded-full blur-[120px] pointer-events-none z-0"
        style={{ backgroundColor: 'rgba(24, 240, 122, 0.03)' }}
      ></div>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-between p-6 sm:p-12 min-h-screen">
        ...
        <main className="w-full max-w-7xl mx-auto flex flex-col justify-end items-start flex-1 pb-16 pt-24 z-10">
        ...
        <footer className="w-full max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-zinc-900/60 font-sans font-medium z-20">
