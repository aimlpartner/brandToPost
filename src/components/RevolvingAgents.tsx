...
const AGENTS = [
  ...
  },
  {
    ...
    avatar: "/agents_img/Gemini_Generated_Image_wow9hxwow9hxwow9.png",
    color: "#FF7778",
  ...
  },
  {
    ...
    avatar: "/agents_img/Gemini_Generated_Image_ultre0ultre0ultr.png",
    color: "#7C3AED",
  ...
  },
  {
    ...
    avatar: "/agents_img/Gemini_Generated_Image_victor.png",
    color: "#10B981",
  ...
  },
  {
    ...
    avatar: "/agents_img/Gemini_Generated_Image_max.png",
    color: "#2583EB",
  ...
  },
  {
    ...
    avatar: "/agents_img/Gemini_Generated_Image_ge8higge8higge8h.png",
    color: "#7C3AED",
        ...
        >
          {AGENTS.map((agent, i) => {
            ...
            return (
              <div 
                key={agent.id}
                className="absolute h-[330px] bg-white border border-slate-200/80 rounded-3xl flex flex-col overflow-hidden transition-all duration-500 shadow-md"
                style={{
                  width: cardWidth,
                  transformStyle: 'preserve-3d',
