  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-full bg-[#0A0A0F] relative overflow-hidden">
      <div className="flex-1 flex items-center justify-center relative">
        <div className="absolute w-[180px] h-[180px] md:w-[240px] md:h-[240px] rounded-full filter blur-[25px] mix-blend-screen opacity-70 animate-pulse bg-gradient-to-r from-[#7C3AED]/40 to-[#2583EB]/20 z-0"></div>
        <img 
      ...
      <div className="pb-10 flex flex-col items-center relative">
        <div className="absolute bottom-[30px] w-[140px] h-[80px] rounded-full filter blur-[20px] opacity-70 animate-pulse bg-gradient-to-r from-[#7C3AED]/30 to-[#2583EB]/20 z-0 delay-700"></div>
